...
export async function getProspectsForTag(this: IExecuteFunctions, index: number) {
  const body = {};
  ...
  // Make API request
  const response = await apiRequest.call(this, 'GET', `/tags/${tagId}/prospects`, body, qs);
